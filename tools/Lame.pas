...
// set one of brate compression ratio.  default is compression ratio of 11.
  lame_set_brate_t = function(handle : PLame_global_flags; i: Integer): Integer; cdecl;
...
// required call to initialize decoder
  ...
  lame_decode_exit_t = function : Integer; cdecl;
 ...
 *********************************************************************)
  lame_decode_t = function(mp3buf : PByte; len : Integer; pcm_l, pcm_r : PShortInt): Integer; cdecl;
...
{$IFNDEF WIN32}
  ...
  {$IFDEF LINUX}
  Libhandle := dlopen(LAME_PATH, 1);
  {$ELSE}
  Libhandle := dlopen(LAME_PATH, 0);
  {$ENDIF}
  ...
  begin
    ...
    lame_decode_exit := dlsym(Libhandle, 'lame_decode_exit');
...
{$IFDEF WIN32}
  ...
  begin
    ...
    lame_decode_exit:=GetProcAddress(Libhandle, 'lame_decode_exit');
